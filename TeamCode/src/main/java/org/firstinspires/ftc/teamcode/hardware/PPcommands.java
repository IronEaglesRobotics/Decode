...
public class PPcommands extends CommandBase {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower,boolean isBlue) {
            ...
            double shootX = isBlue ? 56:88;
            double prePickX = isBlue ? 50:100;
            double postPickX1 = isBlue ? 10:130;
            double postPickX2 = isBlue ? 13:127;
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(startX, 135.000), new Pose(shootX, 95.500))
                    )
                    .setLinearHeadingInterpolation(flipAng(135,isBlue),flipAng(135,isBlue))
                    .build();
